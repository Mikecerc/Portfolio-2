<template>
    <div class="wrapper">
        ...
        <h1 class="text_404" width="300px">Under Construction</h1>
        <p class="subtext_404" width="200px">This page is currently under construction. Check back soon!</p>
...
<style>@import "../../assets/css/build/pages/404.css"</style>
